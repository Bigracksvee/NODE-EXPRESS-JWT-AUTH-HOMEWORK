...
const { checkUser } = require('./views/partials/middleware/authMiddleware');
...
// database connection
const dbURI = 'mongodb+srv://mean1234:mean1234@node-express-jwt-auth.thlpdlu.mongodb.net/test';
